...
@Component({
  selector: 'app-talk-to-ca',
  imports: [CommonModule],
  templateUrl: './talk-to-ca.component.html',
  styleUrl: './talk-to-ca.component.scss'
})
export class TalkToCaComponent {
  ...
  expertiseList = [
   ...
   // Variable to manage the modal's open/close state
